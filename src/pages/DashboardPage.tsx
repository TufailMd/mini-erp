      ...
      <main className="flex-1 p-6 flex justify-center">
        <div className="w-full max-w-4xl pt-4">
          <ModuleOverviewSection 
            ...
            onFilterClick={(status, scope) => handleFilterClick('Sale Orders', status, scope)} 
          />
          <ModuleOverviewSection 
            metrics={purchaseOrdersMetrics} 
            onFilterClick={(status, scope) => handleFilterClick('Purchase Orders', status, scope)} 
          />
          <ModuleOverviewSection 
            metrics={manufacturingOrdersMetrics} 
            onFilterClick={(status, scope) => handleFilterClick('Manufacturing Orders', status, scope)} 
          />
        </div>
      </main>
    </div>
