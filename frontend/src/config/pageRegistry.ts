...
import SalesOrderCreatePage from '@/modules/sales/pages/SalesOrderCreatePage'
...
import MOFormPage from '@/modules/manufacturing/pages/MOFormPage'
...
import UserManagementListPage from '@/modules/users/pages/UserManagementListPage'
import UserManagementDetailPage from '@/modules/users/pages/UserManagementDetailPage'
